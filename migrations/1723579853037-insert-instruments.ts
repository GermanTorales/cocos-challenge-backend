...
export class InsertInstruments1723579853037 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
             DELETE FROM instruments WHERE ticker IN (
                'DYCA', 'CAPX', 'PGR', 'MOLA', 'MIRG', 'PATA', 'TECO2', 'FERR', 'SAMI', 'IRCP',
                'GAMI', 'DOME', 'INTR', 'MTR', 'FIPL', 'GARO', 'SEMI', 'HARG', 'BPAT', 'RIGO',
                'CVH', 'BBAR', 'LEDE', 'CELU', 'CECO2', 'AGRO', 'AUSO', 'BHIP', 'BOLT', 'CARC',
                'BMA', 'CRES', 'EDN', 'GGAL', 'DGCU2', 'GBAN', 'CGPA2', 'CADO', 'GCLA', 'GRIM',
                'RICH', 'MOLI', 'VALO', 'TGNO4', 'LOMA', 'IRSA', 'PAMP', 'TGSU2', 'TXAR', 'YPFD',
                'MORI', 'INVJ', 'POLL', 'METR', 'LONG', 'SUPV', 'ROSE', 'OEST', 'COME', 'CEPU',
                'ALUA', 'CTIO', 'TRAN', 'HAVA', 'BYMA', 'ARS'
            );
        `);
  }
}
